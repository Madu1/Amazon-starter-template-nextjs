  ...
  return (
    <div className="relative border rounded-md">
        <div className="flex items-center space-x-10 p-5 bg-gray-100 text-sm text-gray-600">
            ...
            <p className="text-sm whitespace-nowrap sm:text self-end flex-1 text-right text-blue-500">{items.length}items</p>
        ...
        <div className="p-5 sm:p-10">
            <div className="flex space-x-6 overflow-auto">
                {images.map(image => (
                    <img src={image} alt="order placed" className="h-20 object-contain sm:h-32" />
                ))}
            </div>
        </div>
